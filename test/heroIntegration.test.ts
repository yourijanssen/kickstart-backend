...
//     setHeroNameByIdStub = heroDatabaseStub.setHeroNameById as SinonStub;
...
//   /**
//    * Test case: should update a hero name by ID.
//    */
//   it('should update a hero name by ID', async () => {
//     const hero: Hero = { id: 1, name: 'Superman' };
//     setHeroNameByIdStub.resolves();
//     await heroService.updateHeroNameById(1, 'Superman');
//     expect(setHeroNameByIdStub.calledOnceWith(hero)).to.be.true;
//   });
...
//     const invalidName = '';
//     try {
//       await heroService.updateHeroNameById(1, invalidName);
...
//   /**
//    * Test case: should throw an error when creating a hero with an empty name.
//    */
//   it('should throw an error when creating a hero with an empty name', async () => {
//     const invalidName = '';
//     try {
//       await heroService.createHero(invalidName);
//       // If the promise resolves successfully, fail the test
//       expect.fail('Expected an error, but promise resolved successfully.');
//     } catch (error: any) {
//       expect(error).to.be.instanceOf(Error);
//       expect(error.message).to.equal(
//         'Invalid hero name. The name must have a length of 1 or more.'
//       );
//     }
//   });
